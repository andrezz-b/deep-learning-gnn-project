...
class GraphSAGE(torch.nn.Module):
    def __init__(self, num_node_features: int, hidden_channels: int = 64):
        ...
        self.conv1: SAGEConv = SAGEConv(num_node_features, hidden_channels)
        self.conv2: SAGEConv = SAGEConv(hidden_channels, hidden_channels)
...
class GATv2(torch.nn.Module):
    def __init__(
        self, num_node_features: int, hidden_channels: int = 64, heads: int = 4
    ):
